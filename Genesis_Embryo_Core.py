'''GENESIS EMBRYO CORE v5.2.1 — Phase 3.3: Enhanced Logging & Dynamic Strategies'''
...
from CrashTracker import CrashTracker
...
from MemoryOptimizer import EfficientStateManager, TimeSimEngine, MemoryAIManager
...
def build_db_path(args):
    """
    Construct a duckdb filename that encodes your run parameters.
...
# ─── Build and populate your global StrategyRegistry ─────────────────────────
...
# ───────────────────────────────────────────────────────────────────────────────
# CURIOSITY
# replace your entire Curiosity class with this:
...
class Embryo:
    def __init__(
        ...
        self.hb = Heartbeat()      # ← add this line
        ...
        # previous state/reward/Q pointers
        ...
        cfg          — your ConfigManager
        registry     — the globally‐shared StrategyRegistry
        """
#        self.sample   = sample_state
#        self.cfg      = cfg
        # use the one you built in genesis_embryo_core.py
...
"""
 ...
 #           traceback.print_exc()
    ...
    def sync_actions(self):
        # pull strategy names out of your registry
