...
@app.callback(
    [
        ...
        Output('gen-filter', 'options'),
        Output('gen-filter', 'value'),
    ...
    [State('strategy-filter', 'value'), State('gen-filter', 'value')]
)
def update_dashboard(n, selected_strategies, selected_gens):
